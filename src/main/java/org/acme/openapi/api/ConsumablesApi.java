...
/**
  ...
  */
@Path("/{language}/items/consumables")
...
public interface ConsumablesApi {
    ...
    @GeneratedMethod ("getItemsConsumablesList")
    public ItemsListPaged getItemsConsumablesList(
    ...
    @Path("/search")
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsConsumablesSearch")
    public List<ItemListEntry> getItemsConsumablesSearch(
        @GeneratedParam("language") @PathParam("language") String language, 
    ...
    @Path("/{ankama_id}")
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsConsumablesSingle")
    public Resource getItemsConsumablesSingle(
        @GeneratedParam("language") @PathParam("language") String language, 
