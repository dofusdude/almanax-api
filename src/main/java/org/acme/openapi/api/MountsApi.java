...
import org.acme.openapi.model.Mount;
import org.acme.openapi.model.MountListEntry;
import org.acme.openapi.model.MountsListPaged;
...
public interface MountsApi {
    ...
    @GeneratedMethod ("getMountsList")
    public MountsListPaged getMountsList(
        @GeneratedParam("language") @PathParam("language") String language, 
        @GeneratedParam("filter[family_name]") @QueryParam("filter[family_name]") String filterFamilyName, 
    ...
    @Path("/search")
    @Produces({"application/json"})
    @GeneratedMethod ("getMountsSearch")
    public List<MountListEntry> getMountsSearch(
        @GeneratedParam("language") @PathParam("language") String language, 
    ...
    @Path("/{ankama_id}")
    @Produces({"application/json"})
    @GeneratedMethod ("getMountsSingle")
    public Mount getMountsSingle(
        @GeneratedParam("language") @PathParam("language") String language, 
