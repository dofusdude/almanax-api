...
public interface EquipmentApi {
    ...
    @GeneratedMethod ("getItemsEquipmentList")
    public ItemsListPaged getItemsEquipmentList(
    ...
    @Path("/search")
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsEquipmentSearch")
    public List<ItemListEntry> getItemsEquipmentSearch(
        @GeneratedParam("language") @PathParam("language") String language, 
    ...
    @Path("/{ankama_id}")
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsEquipmentSingle")
    public Weapon getItemsEquipmentSingle(
        @GeneratedParam("language") @PathParam("language") String language, 
