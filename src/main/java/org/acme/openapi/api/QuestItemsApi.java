...
public interface QuestItemsApi {
    ...
    @GeneratedMethod ("getItemQuestSingle")
    public Resource getItemQuestSingle(
    ...
    @GET
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsQuestList")
    public ItemsListPaged getItemsQuestList(
        @GeneratedParam("language") @PathParam("language") String language, 
    ...
    @Path("/search")
    @Produces({"application/json"})
    @GeneratedMethod ("getItemsQuestSearch")
    public List<ItemListEntry> getItemsQuestSearch(
        @GeneratedParam("language") @PathParam("language") String language, 
