...
import org.acme.openapi.model.Cosmetic;
...
public interface CosmeticsApi {
    ...
    @GeneratedMethod ("getCosmeticsList")
    public ItemsListPaged getCosmeticsList(
    ...
    @Path("/search")
    @Produces({"application/json"})
    @GeneratedMethod ("getCosmeticsSearch")
    public List<ItemListEntry> getCosmeticsSearch(
        @GeneratedParam("language") @PathParam("language") String language, 
    ...
    @Path("/{ankama_id}")
    @Produces({"application/json"})
    @GeneratedMethod ("getCosmeticsSingle")
    public Cosmetic getCosmeticsSingle(
        @GeneratedParam("language") @PathParam("language") String language, 
