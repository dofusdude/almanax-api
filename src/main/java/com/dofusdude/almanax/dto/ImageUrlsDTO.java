...
public class ImageUrlsDTO {
    /**
     * All images except icon are rendered in the background which can take some
     * time (up to hours if all data is completely generated from scratch). Because
     * of this, they can be null if they are not yet rendered.
     **/
    public String icon;
    /**
     * All images except icon are rendered in the background which can take some
